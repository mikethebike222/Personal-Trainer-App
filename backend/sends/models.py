...
class Member(models.Model): 
    ...
    hasJob = models.CharField(max_length=30, default='Yes')
    monthlyIncome = models.CharField(max_length=100, default="N/A", blank=True, null=True)
    whatsapp = models.CharField(max_length=100, default="none", blank=True, null=True)
