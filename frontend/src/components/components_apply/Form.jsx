...
const Form = () => {
    ...
    const validateForm = (data) => {
        ...
        if (data.signature.trim() !== expectedSignature) {
            ...
            <form onSubmit={handleSubmit}>
                <div className={styles.formRow}>
                    <div className={styles.formGroup}>
                        ...
                        {errors.fname && <div className={styles.errorBox}>{errors.fname}</div>}
                        <input type='text' value={formData.fname} name='fname' onChange={handleChange} />
                    </div>
                    <div className={styles.formGroup}>
                        <label htmlFor='lastname'>Last Name (required)</label>
                        {errors.lname && <div className={styles.errorBox}>{errors.lname}</div>}
                ...
                <div className={styles.formRow}>
                    ...
                    <div className={styles.formGroup}>
                        ...
                        {errors.phone && <div className={styles.errorBox}>{errors.phone}</div>}
                ...
                <div className={styles.formRow}>
                    <div className={styles.formGroup}>
                        ...
                        {errors.age && <div className={styles.errorBox}>{errors.age}</div>}
                    ...
                    <div className={styles.formGroup}>
                        ...
                        {errors.height && <div className={styles.errorBox}>{errors.height}</div>}
                ...
                <div className={styles.formRow}>
                    <div className={styles.formGroup}>
                        ...
                        {errors.weight && <div className={styles.errorBox}>{errors.weight}</div>}
                ...
                <div className={styles.formGroup}>
                    ...
                    {errors.goal && <div className={styles.errorBox}>{errors.goal}</div>}
                ...
                <textarea name='stuck' id='stuck' cols='30' rows='10' value={formData.stuck} onChange={handleChange}></textarea>
...
By signing here with Jacob Oestreicher Coaching, clients confirm they have read, understood, and agreed to the terms outlined in this policy.</p>
                ...
                {errors.signature && <div className={styles.errorBox}>{errors.signature}</div>}
                ...
                <div className={styles.checkboxRow}>
                    <label className={styles.checkboxlabel} htmlFor='signup'>
                        <input className={styles.checkInput} type='checkbox' name='signup' checked={formData.signup} onChange={handleChange} />
                        I agree to receive SMS and email updates related to Jacob Oestreicher Coaching.
                    </label>
                </div>
                <button className={styles.formButton} type='submit' disabled={loading}>Submit</button>
                {loading && (
                    <div className={styles.loadingContainer}><div className={styles.loader}></div></div>
                )}
